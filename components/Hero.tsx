...
const floatingCards = [
  { icon: '⚡', label: 'Next.js 14', color: 'from-blue-500/20 to-cyan-500/20', delay: 0 },
  { icon: '🐍', label: 'Django REST', color: 'from-green-500/20 to-emerald-500/20', delay: 0.5 },
  { icon: '🚀', label: 'SaaS Builder', color: 'from-purple-500/20 to-pink-500/20', delay: 1 },
  { icon: '🤖', label: 'AI Powered', color: 'from-amber-500/20 to-orange-500/20', delay: 1.5 },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative w-80 h-80">
              ...
              >
                <div className="text-2xl font-display font-black text-brand-500">4+</div>
