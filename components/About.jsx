...
const metrics = [
  ...
  { icon: Coffee, value: '1+', label: 'Years Experience', color: 'text-amber-500' },
          ...
          >
            <div className="space-y-4 text-[var(--text-secondary)] leading-relaxed text-lg">
              <p>
                ...
                with  1+years of experience building production-grade web applications and SaaS platforms that scale.
              </p>
              <p>
          ...
          >
            ...
            >
              ...
              <div className="space-y-1 text-xs leading-relaxed">
                ...
                <div className="pl-4"><span className="text-emerald-400">name</span><span className="text-[var(--text-secondary)]">:</span> <span className="text-amber-400">'Shoaib Siraj'</span><span className="text-[var(--text-secondary)]">,</span></div>
